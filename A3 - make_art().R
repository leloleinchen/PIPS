...
make_art <- function (myseed){
  ...
  mydf <- data.frame(
    ...
    a = 0.8*cos(mytheta) + rnorm(100, 1, 0.04),
    b = 0.8*sin(mytheta) + rnorm(100, 1, 0.04),
    
    c = 0.5*cos(mytheta) + rnorm(100, 1, 0.04),
    d = 0.5*sin(mytheta) + rnorm(100, 1, 0.04),
    
    e = 0.2*cos(mytheta) + rnorm(100, 1, 0.04),
    f = 0.2*sin(mytheta) + rnorm(100, 1, 0.04)
